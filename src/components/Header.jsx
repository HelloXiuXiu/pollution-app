    ...
    <header className={'header ' + image}>
      ...
      { contributionOpen &&
        <PopUp wrapperClass="contribution-popup" setIsOpen={setContributionOpen}>
          ...
          <br /><br />
          <p>Source code (native version): <a href="https://github.com/HelloXiuXiu/pollution-app-native" target="_blank" rel="noopener nofollow noreferrer">GitHub</a></p>
          <p>Web version: <a href="https://github.com/HelloXiuXiu/pollution-app" target="_blank" rel="noopener nofollow noreferrer">GitHub</a></p>
